// new item navigation drawer
// src/renderer/router/nav_vizdata.ts
export const climateHydrologyNav = {
    name: 'Visualization Data',
    routeName: 'viz', // ID group route
    show: true,
    items: [
        {
        ...
        },
        {
            ...
            subItems: [
                ...
                { name: 'Frequency Analysis', path: '/edit/visualization_data/stats/freqanal', show: true, routeName: 'vizStatsfreq', subItems: [
